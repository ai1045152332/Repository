...
public class PagerSimple {
     ...
     */
    public PagerSimple(Integer pageCount, Integer currentPage, int maxButtonCount, String nextPageLabel, String prevPageLabel, String firstPageLabel, String lastPageLabel, String header, String footer, String cssFile, Map<String, String> htmlOptions)
    {
    ...
    public PagerSimple(Integer pageCount, Integer currentPage)
    {
        this.nextPageLabel="下一页";
        this.prevPageLabel="上一页";
        this.firstPageLabel="首页";
    ...
    public PagerSimple(Integer pageCount, Integer currentPage, String prevPageLabel, String nextPageLabel, String firstPageLabel, String lastPageLabel, Boolean javascript)
    {
        this.nextPageLabel=nextPageLabel;
        this.prevPageLabel=prevPageLabel;
        this.firstPageLabel=firstPageLabel;
    ...
    public PagerSimple(Integer pageCount, Integer currentPage, int maxButtonCount, String prevPageLabel, String nextPageLabel, String firstPageLabel, String lastPageLabel, Boolean javascript)
    {
        this.nextPageLabel=nextPageLabel;
        this.prevPageLabel=prevPageLabel;
        this.firstPageLabel=firstPageLabel;
    ...
    public PagerSimple(Integer pageCount, Integer currentPage, Boolean javascript)
    {
        this.nextPageLabel="下一页";
        this.prevPageLabel="上一页";
        this.firstPageLabel="首页";
    ...
    protected String createPageButton(String label,int page,String classtyle,boolean hidden,boolean selected)
    {
        ...
        else
        {
            if(this.javascript)
            {
                return "<li class='"+classtyle+"'><a href='javascript:void(0)' onclick='parent.jumpPage("+page+")'>"+label+"</a></li>";
            }
            else
            {
//                return "<li class='"+classtyle+"'><a href='"+queryString+"'>"+label+"</a></li>";
                return "<li class='"+classtyle+" '><a href='javascript:void(0)'>"+label+"</a></li>";
            }
        }
    }
}
