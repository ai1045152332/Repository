package com.zjy.filesystem.api.controller;
...
public class FileController {
	...
	@ResponseBody
	public List<UploadFile> listFilesByPage(@PathVariable int pageIndex, @PathVariable int pageSize) {
	...
	public ResponseEntity<Object> serveFile(@PathVariable String id) throws UnsupportedEncodingException {
		...
		Optional<UploadFile> file = fileService.getFileById(id);
	...
	public String handleFileUpload(@RequestParam("file") MultipartFile file, RedirectAttributes redirectAttributes) {
		...
		try {
			UploadFile f = new UploadFile(file.getOriginalFilename(), file.getContentType(), file.getSize(),
