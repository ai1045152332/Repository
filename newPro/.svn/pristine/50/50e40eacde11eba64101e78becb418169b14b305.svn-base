...
<div class="public">
  ...
  <div class="mm" style='height:100%;background:#707681;'>
    ...
    <div class="split_screen_p">
      <div class="split_screen_bottom" style="margin-top:8%;">
        ...
        <div class="split_screen_bottom_r">
          <div class="center_right">
            <object  CLASSID="CLSID:3a22176d-118f-4185-9653-cdea558a6df8" name="ScriptableObject" id="ScriptableObject2" title="<%=device1[1]%>---<%=device1[5]%>---<%=device1[6]%>---<%=mediaUrlList.get(device[1]).toString()%>"
