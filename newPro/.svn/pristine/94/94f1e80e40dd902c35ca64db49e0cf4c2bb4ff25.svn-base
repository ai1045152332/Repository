  ...
  <div class="public_nav">
    <ul>
      <%
        ...
        String hhtwplan = "0";//定时计划
        if (UserService.authCheck(uid.toString(),"hhtwbplan:retrieve",system)) {
          hhtwplan = "1";
        }
        ...
        dic.put("/pages/frontend/dmanager", new String[]{ServletActionContext.getRequest().getContextPath() + "/hhtwhiteboard/HHTWhiteboard_getHostGroup.do", "设备控制", dmanager});
        dic.put("/pages/frontend/policy", new String[]{ServletActionContext.getRequest().getContextPath() + "/policy/Policy_policyList.do", "定时计划", hhtwplan});
