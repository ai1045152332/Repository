...
<head>
    ...
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/js/common/layer/extend/layer.ext.atv.js"></script>
    ...
    <div class="xk_option">
        <div class="xk_options" style="width: auto">
            ...
            <span class="xk_options_open" id="touch_screen">
                <span class="jkn_mc_touchscreenicon" id="power_img"></span>
                <span class="xk_options_text">触控切换</span>
                <div class="jkn_mc_powerson" style="z-index: -1;">
                </div>
            </span>
            ...
            <span class="xk_options_stoprecording" id="audio_control">
                <span class="toggleaudiocontrol">
                    ...
                    <div id="audio_control_id" class="jkn_mc_powerson" style="width: 160px;z-index: -1;">
                        <div class="jkn_mc_powerson_cover"></div>
                        <div id="opts">
                            <div style="float: left;">0</div>
                            <div style="width: 100px;float: left;margin: 0 3px;">
                                <input id="currentAudio" type="text" name="lines" min="0" max="100" value="0">
                            </div>
                            <div id="opt-lines" class="litval" style="float: left;">0</div>
                        </div>
                    </div>
            </span>
            ...
            <%--<span class="xk_options_stoprecording" id="wifi_control">--%>
            <%--<span class="jkn_mc_remoteenergyicon" id="wifi_control_img"></span>--%>
            <%--<span class="xk_options_text">wifi状态控制</span>--%>
            <%--<div class="jkn_mc_powerson" style="z-index: -1;">--%>
            <%--</div>--%>
            <%--</span>--%>
            <%--<span class="xk_options_stoprecording" id="touch_screen">
                <span class="jkn_mc_touchscreenicon" id="touch_screen_img"></span>
                <span class="xk_options_text">触屏管理</span>
                <div  class="jkn_mc_powerson"  style="z-index: -1;">
                </div>
            </span>--%>
            ...
            <span class="xk_options_more" id="xk_options_more">
                ...
                <span class="xk_options_text">更多</span>
                    ...
                    if (hoststatus == "Offline") {
                        ...
                        for (var i = 0; i < arr_cmd.length; i++) {
                            if (arr_cmd[i] != current) {
                                if (arr_cmd[i]) {
                                    str += '<li onclick="change_signal(\'' + arr_cmd[i] + '\',\'' + arr[i] + '\',\'' + hostidstr + '\')">' + arr[i];
                                } else {
                                    str += '<li onclick="change_signal(\'null\',\'' + arr[i] + '\',\'' + hostidstr + '\')">' + arr[i];
                                }
                            } else {
                                if (current != "")
                                    str += '<li style="color:green;font-weight:bold" onclick="change_signal(\'null\',\'' + arr[i] + '\',\'' + hostidstr + '\')">' + arr[i];
                            }
                        }
                        $(this).find(".jkn_mc_powerson").html(str);
                    }
...
//                        if (current_audio) {
                        ...
                        if (zindex >= 0) {
                            ...
                            if (current == "") {
                                ...
                                $("#opt-lines").html(current);
                            }

                            $("#fd-slider-currentAudio").children("span").eq(1).css("width", current + "px")
                            $("#fd-slider-currentAudio").children("span").eq(2).css("left", 0 + "px")
                            $("#fd-slider-currentAudio").children("span").eq(2).attr("aria-valuenow", current)
                            $("#fd-slider-currentAudio").children("span").eq(3).css("left", current + "px")
                        } else {
                            if (current == "") {
                                $("#opt-lines").html(0);
                            } else {
...
//                        }
            ...
            if (hostidstr > 0) {
                ...
                if (hostidstr == 1) {
                    ...
                    if (hoststatus == "Offline") {
                        ...
                        var str = '';
                        current = $("#go").contents().find("#status_" + hostid).attr("audio_mode");
                        for (var i = 0; i < arr.length; i++) {
                            if (arr_cmd[i] != current) {
                                if (arr_cmd[i]) {
            ...
            if (hostidstr > 0) {
                ...
                if (hostidstr == 1) {
                    ...
                    if (hoststatus == "Offline") {
                        ...
                        var hostid = $(".jkn_treecheckboxed").eq(0).attr("hostId");
                        var hostip = $(".jkn_treecheckboxed").eq(0).attr("hostIp");
                        var strcode = "";
                        $.post(root_path + '/dmanager/DManager_ring.do', {
                            hostIp: hostip,
                            cmdCode: strcode
                        }, function (data) {
            ...
            if (hostidstr > 0) {
                ...
                if (hostidstr == 1) {
                    ...
                    if (hoststatus == "Offline") {
                        ...
                        var hostip = $(".jkn_treecheckboxed").eq(0).attr("hostIp");
                        var strcode = "";
                        $.post(root_path + '/dmanager/DManager_cleanRubbish.do', {
                            hostIp: hostip,
                            cmdCode: strcode
                        }, function (data) {
                            if (data.success == "true") {
                        ...
                        $.layer({
                            ...
                            dialog: {
                                ...
                                yes: function () {
                                    var hostidstr = $(".jkn_treecheckboxed").length;
                                    var hostip = $(".jkn_treecheckboxed").eq(0).attr("hostIp");
                                    $.post(root_path + '/dmanager/DManager_backup.do', {hostIp: hostip}, function (data) {
                                        if (data.success == "true") {
                                            layer.msg("系统备份中");
                                        }
                                        else {
                    ...
                    if (hoststatus == "Offline") {
                        ...
                        $.layer({
                            ...
                            dialog: {
                                ...
                                yes: function () {
                                    var hostip = $(".jkn_treecheckboxed").eq(0).attr("hostIp");
                                    $.post(root_path + '/dmanager/DManager_recovery.do', {hostIp: hostip}, function (data) {
                                        if (data.success == "true") {
                                            layer.msg("系统还原中");
                                        }
                                        else {
        ...
        $("#wifi_control").click(function () {
            var hostidstr = $(".jkn_treecheckboxed").length;
            if (hostidstr > 0) {
                var wifistatusArr = getInfo("wifi_control");
                var cmdArr = wifistatusArr[0];
                var cmd_codeArr = wifistatusArr[1];
                var hostid = "";
                var current = "";
                if (hostidstr == 1) {
                    hostid = $(".jkn_treecheckboxed").eq(0).attr("hostId");
                    current = $("#go").contents().find("#status_" + hostid).attr("");//当前的wifi状态
                }
            ...
            if (hostidstr > 0) {
                ...
                if (hostidstr == 1) {
                    ...
                    if (hoststatus == "Offline") {
                        ...
                        var str = '';
                        current = $("#go").contents().find("#status_" + hostid).attr("remote_energy");
                        for (var i = 0; i < arr.length; i++) {
                            if (arr_cmd[i] != current) {
                                if (arr_cmd[i]) {
            ...
            if (hostidstr > 0) {
                ...
                if (hostidstr == 1) {
                    ...
                    if (hoststatus == "Offline") {
                        ...
                        var str = '';
                        current = $("#go").contents().find("#status_" + hostid).attr("touch_screen");
                        for (var i = 0; i < arr_cmd.length; i++) {
                            if (arr_cmd[i] != current) {
                                if (arr_cmd[i]) {
...
//                var currentPage=$("#go").contents().find("#current").val();
                var currentPage = $.cookie("curPageHHTC") || 1;
                src += "/dmanager/DManager_deviceList.do?groupid=" + groupid + "&currentPage=" + currentPage + "&pageSize=" + pageSize;
                if (self.frames[0].document.readyState === 'complete' && $(window.frames["go"].document).find("div[ip='" + token + "']").length != 0) {
                    $("#go").attr("src", src);
                    $("#selected_host").val("");
                }
            }
        ...
        message.processOtherEvent = function (token, eventType, desc) {
            ...
            if (self.frames[0].document.readyState === 'complete') self.frames[0].setval(parames, dapingip, types);
    ...
    function change_touch_screen(strcode, str, hostidstr) {
        ...
        for (var i = 0; i < hostidstr; i++) {
            ...
            var hostip = $(".jkn_treecheckboxed").eq(i).attr("hostIp");
            if (strcode != 'null') {
                $.post(root_path + '/dmanager/DManager_changeTouchScreen.do', {
                    hostIp: hostip,
                    cmdCode: strcode
                }, function (data) {
                    if (data.success == "true") {
    ...
    function change_remote_energy(strcode, str, hostidstr) {
        for (var i = 0; i < hostidstr; i++) {
            ...
            var hostip = $(".jkn_treecheckboxed").eq(i).attr("hostIp");
            if (strcode != 'null') {
                $.post(root_path + '/dmanager/DManager_changeRemoteEnergy.do', {
                    hostIp: hostip,
                    cmdCode: strcode
                }, function (data) {
                    if (data.success == "true") {
    ...
    function change_audio_mode(strcode, str, hostidstr) {
        for (var i = 0; i < hostidstr; i++) {
            ...
            var hostip = $(".jkn_treecheckboxed").eq(i).attr("hostIp");
            if (strcode != 'null') {
                $.post(root_path + '/dmanager/DManager_changeAudioMode.do', {
                    hostIp: hostip,
                    cmdCode: strcode
                }, function (data) {
                    if (data.success == "true") {
    ...
    function change_signal(strcode, str, hostidstr) {
        for (var i = 0; i < hostidstr; i++) {
            ...
            var hostip = $(".jkn_treecheckboxed").eq(i).attr("hostIp");
            if (strcode != 'null') {
                if (strcode == "ATV" || strcode == "DTV") {
                    layer.prompt({
                        title: '请输入要切换的频道号',
                        formType: 1 //prompt风格，支持0-2
                    }, function (cmdCode) {
                        for (var k = 0; k < hostidstr; k++) {
                            var hostid = $(".jkn_treecheckboxed").eq(k).attr("hostId");
                            var hostip = $(".jkn_treecheckboxed").eq(k).attr("hostIp");
                            $.post(root_path + '/dmanager/DManager_changeAtvOrDtv.do', {
                                hostIp: hostip,
                                cmdCode: cmdCode,
                                TVName: strcode
                            }, function (data) {
                                if (data.success == "true") {
                                    layer.msg("切换成功", 1)
                                    $("#go").contents().find("#status_" + hostid).attr("atvordtv", val);
                                } else {
                                    layer.msg("切换失败", 1)
                                }
                            });
                    ...
                    $.post(root_path + '/dmanager/DManager_changeSignal.do', {
                        hostIp: hostip,
                        cmdCode: strcode
                    }, function (data) {
                        if (data.success == "true") {
    ...
    function wakeup(hostidstr) {
        ...
        var hostIps = "";
        for (var i = 0; i < hostidstr; i++) {
            var hostIps = hostIps + $(".jkn_treecheckboxed").eq(i).attr("hostip") + ",";
            var status = $(".jkn_treecheckboxed").eq(i).attr("status");
        }
        $.post(root_path + '/dmanager/DManager_start.do', {hostIpStr: hostIps}, function (data) {
            if (data.success == "true") {
    ...
    function shutdown(hostidstr) {
        ...
        $.post(root_path + '/dmanager/DManager_shutdown.do', {
            hostIpStr: hostIps,
            cmdCode: "ShutDown"
        }, function (data) {
            if (data.success == "true") {
...
////                    $("#go").contents().find("#host_status_" + hostid).val("Offline");
////                    window.location.reload();
//                    console.log("hostip:"+hostip+"关机成功");
//                } else {
//                    //layer.msg("关机失败",1)
//                }
//            });
//        }
        ...
        $("#opts").live("mouseup", function () {
            ...
            if (hostidstr > 0) {
                for (var i = 0; i < hostidstr; i++) {
                    ...
                    $.post(root_path + '/dmanager/DManager_audioControl.do', {
                        hostIp: hostip,
                        cmdCode: val
                    }, function (data) {
                        if (data.success == "true") {
    ...
    $("#atvordtv").click(function () {
        var hostidstr = $(".jkn_treecheckboxed").length;
        if (hostidstr > 0) {
            var j = 0;
            for (var i = 0; i < hostidstr; i++) {
                var hostid = $(".jkn_treecheckboxed").eq(i).attr("hostId");
                var currentSignal = $("#go").contents().find("#status_" + hostid).attr("signal");
                if (currentSignal != "ATV" && currentSignal != "DTV") {
                    j++;
                }
            }
            if (j > 0) {
                layer.alert("切换频道只在信号源为数字电视或模拟电视下使用");
            } else {
                layer.prompt({
                    title: '请输入要切换的频道号',
                    formType: 1 //prompt风格，支持0-2
...
//        if (pageSize != screen) {
        if (pageSize == screen) {
            ...
            if (screen == 4) {
                $("#go").attr("src", "")
                $("#go").attr("src", root_path + '/dmanager/DManager_deviceList.do?groupid=' + groupid + '&pageSize=' + screen + '&currentPage=1');
            }
            else {
                $("#go").attr("src", "")
                $("#go").attr("src", root_path + '/dmanager/DManager_deviceList.do?groupid=' + groupid + '&pageSize=' + screen + '&currentPage=1');
