...
public class SearchPathTools {
	private final static Logger logger= Logger.getLogger(SearchPathTools.class);
	...
	public static final String publishPathRelative = "../webapps/" + serverName + "/data/projects/publish/";
	...
	public static final String templatePathRelative = "../webapps/" + serverName + "/data/projects/template/";
	
	public static final String templatePathAbsolute = host + "/" + serverName + "/data/projects/template/";
	
	public static final String modelPath = "../webapps/" + serverName + "/data/product/";
...
//	}
	...
	public static String getEditPreviewPath(boolean isAbsolute ,int type,String userName,String prid,String pid,long timestamp,String sig ){
		...
		if(sig.equals("single")){
			...
			if(isAbsolute){
				previewPath = host+"/"+serverName+"/data/projects/edit/"+userName+"/"+prid+"/previewSingle";
//				previewPath = "/data/projects/edit/"+userName+"/"+prid+"/preview";
			}
		}else{
			previewPath = editPathRelative +userName+"/"+prid+"/preview";
			if(isAbsolute){
				previewPath = host+"/"+serverName+"/data/projects/edit/"+userName+"/"+prid+"/preview";
//				previewPath = "/data/projects/edit/"+userName+"/"+prid+"/preview";
			}
		}
