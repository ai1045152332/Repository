...
//       	 	var a = DSS.BlockOpr.getProperty('ppt_path');
//       	 	DSS.BlockOpr.setProperty('ppt_path',obj.mapped);
        }
    ...
    DSS.Request.addBlockReq(this.elIds); // 添加PPT的控件
    var wander = this.util.byId(this.elIds[0]);
    DSS.Request.selectPptReq(this.elIds[0],wander,p.mapped,p.path); // 用户选择的PPT所对应的所有image
