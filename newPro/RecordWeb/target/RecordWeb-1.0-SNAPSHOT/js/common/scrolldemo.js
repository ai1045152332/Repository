...
function scrollFunc(e,father){
    ...
    if(e.wheelDelta){//IE/Opera/Chrome
		...
		if(thisvalue>=0){
			...
			scroll_y(father,"scrollson","scroll_y","scroll_ymove","scroll_x","scroll_xmove","","wheely",thisvalue)
...
function touchMove(event) {
    event.preventDefault();
     ...
     if(Math.abs(ylength)>Math.abs(xlength)){
	     ...
	     scroll_y(father,"scrollson","scroll_y","scroll_ymove","scroll_x","scroll_xmove","","wheely",thisval)
     }else{
	    ...
	    // alert(thisval)
	     scroll_y(father,"scrollson","scroll_y","scroll_ymove","scroll_x","scroll_xmove","","wheelx",thisval)
     }
...
function touchEnd(event) {
	...
	*/
	function scroll_y(father,soncontent,scroll_y,scroll_ymove,scroll_x,scroll_xmove,deloradd,wheelxory,wheelval){
		...
		//$("#"+father+" ."+soncontent).css("margin-top", "0");
		console.log("hei_father is = " + hei_father);
		console.log("hei_soncontent is = " + hei_soncontent);
		//y轴
