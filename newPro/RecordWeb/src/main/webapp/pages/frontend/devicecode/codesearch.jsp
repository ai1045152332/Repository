...
<div class="error">
    ...
    <div class="error_pic">
        <span class="error_pictext">没有您要找的数据</span>
    </div>
</div>
<%
    }%>
...
<script>
    function go() {
        ...
        $.post("./frontend/devicecode/Devicecode_codeSearch.do", {
            currentPage: pages,
            dspecName: dspecName,
            cmdName: cmdName
        }, function (data) {
