...
<%
    ...
    Object[] device8 = deviceList.get(8);
	   ...
	   <div class="mm" style='height:100%;background:#707681;'>
	    ...
	    <div class="split_screen_p">
            <div class="split_screen_tetop">
                <div class="reen_vide_p">
                    ...
                    <div class="screen_video_stdt" style="margin-top:1.5%;">
                        <div class="screen_video_stdtam1">
            ...
            <div class="split_screen_tetop">
                ...
                <div class="reen_vide_b">
                    <div class="screen_video_stdtay">
                        <object  CLASSID="CLSID:3a22176d-118f-4185-9653-cdea558a6df8" name="ScriptableObject" id="ScriptableObject9" title="<%=device8[1]%>---<%=device8[5]%>---<%=device8[6]%>---<%=mediaUrlList.get(device8[1]).toString()%>"
                                 url="<%=device8[6]%>" WIDTH=100% HEIGHT=100%>
                        </object>
                    </div>
                </div>
            </div>
	    ...
	    <script type="text/javascript">
            ...
            $(window).resize(function (){ 
                ...
                function ScriptableObject9::OnPtzControl(v)
                {
                    PTZcontrol(v,"<%=device[4]%>")
                };
        </script>
