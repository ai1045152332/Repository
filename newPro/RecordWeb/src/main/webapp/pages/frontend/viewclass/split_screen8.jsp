...
<%
    ...
    Object[] device7 = deviceList.get(7);
...
<div class="public">
	   ...
	   <div class="mm" style='height:100%;background:#707681;'>
	    ...
	    <div class="split_screen_p" style="min-height:780px;">
            <div class="screen_videoim_t">
                <div class="screen_videoim_t_left">
                    <div class="screen_videoim_t_left_i">
                ...
                <div class="screen_videoim_t_right">
                    <div class="screen_videoim_t_left_l">
                        <div class="screen_videoim_t_left_l_i">
                        ...
                        <div class="screen_videoim_t_left_l_t">
            ...
            <div class="screen_videoim_i">
                <div class="screen_videoim_m">
                ...
                <div class="screen_videoim_j">
                    <object  CLASSID="CLSID:3a22176d-118f-4185-9653-cdea558a6df8" name="ScriptableObject" id="ScriptableObject8" title="<%=device7[1]%>---<%=device7[5]%>---<%=device7[6]%>---<%=mediaUrlList.get(device7[1]).toString()%>"
                             url="<%=device7[6]%>" WIDTH=100% HEIGHT=100%>
                    </object>
                </div>
            </div>
        </div>
	    ...
	    <script type="text/javascript">
                $(".screen_videoim_t_left_l_i").width(245 * $(".screen_videoim_t_left_l_i").height() / 168);
                $(".screen_videoim_t_left_l").width(245 * $(".screen_videoim_t_left_l").height() / 350)
                $(".screen_videoim_t_left_i").width($(".screen_videoim_t_left_l_i").width() * 2 + $(".screen_videoim_t_left_l").width() * 4 /100)
                $(".screen_videoim_i").width($(".screen_videoim_t_left_i").width() * 2 + $(".screen_videoim_t").width() * 2.8 / 100)
            $(window).resize(function (){ 
               ...
               // alert($(".screen_videoim_t_left_l_i").width() )
                ...
                function ScriptableObject8::OnPtzControl(v)
                {
                    PTZcontrol(v,"<%=device[4]%>")
                };
        </script>
