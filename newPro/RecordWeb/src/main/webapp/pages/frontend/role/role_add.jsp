...
<style>
    .all{max-width: 200px;width: auto;float: left;}
...
<div class="win520_content">
    ...
    <div class="win_btn" style="margin: 20px 20px 20px 0;" >
        <div class="win_btn_sure" style="margin-right: 180px;" onclick="javascript:addRoleSave()">确定</div>
    </div>
</div>
<%
}
...
<div class="win520_content">
    ...
    %>
    <div class="win_btn" style="margin: 20px 20px 20px 0;" >
        <div class="win_btn_sure" style="margin-right: 180px;" onclick="javascript:alterRoleSave()">确定</div>
    </div>
</div>
<%
}
...
<script type="text/javascript">
    ...
    function addRoleSave()
    {
        ...
        $.get(rootpath+"/role/Role_addRole.do", {rolename: rname,authStr:auths}, function (data) {
...
//                });
                parent.window.location.href=rootpath+"/role/Role_roleList.do";
//                layer.msg(data.msg);
            }
            else
            {
    ...
    function alterRoleSave()
    {
        ...
        $.get(rootpath+"/role/Role_editRole.do", {roleId: rid,rolename:rname,authStr:auths}, function (data) {
            if(data.success==true)
            {
                parent.window.location.href=rootpath+"/role/Role_roleList.do";
                //layer.msg(data.msg);
...
////                var authname = $.trim($(".head").eq(index).text());
////                if(authname=="")
//            }else{
//                //alert(flag)
