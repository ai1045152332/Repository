...
<div class="public">
    ...
    <%
        ...
        Map<String, Object> hostNoRelationHhtcLists = (Map<String, Object>) request.getAttribute("hostNoRelationHhtcLists");
        Map<String, Object> hostNoRelationHhrecLists = (Map<String, Object>) request.getAttribute("hostNoRelationHhrecLists");
        Map<String, Object> hostNoRelationHtprLists = (Map<String, Object>) request.getAttribute("hostNoRelationHtprLists");
        Map<String, Object> hostNoRelationHhtwbLists = (Map<String, Object>) request.getAttribute("hostNoRelationHhtwbLists");
    ...
    <div class="mm floatleft">
        <div class="mm_head floatleft">
            <a href="${pageContext.request.contextPath}/hostgroup/Hostgroup_management.do"><span
                    class="mm_head_option" style="margin-left: 20px;text-indent:15px"><span
                    class="mm_nogroup_icon"></span>返回</span></a>
            <%
                if (!hostNoRelationList.isEmpty()) {
            %>
            <a href="javascript:void(0)" class="moveHosts"><span class="mm_head_option" style="text-indent:15px"><span
                    class="mm_nogroup_moveto"></span>移动到</span></a>
            <%if (hostNoRelationHhtcLists != null && hostNoRelationHhtcLists.size() > 0 && Integer.parseInt(hostNoRelationHhtcLists.get("itemsCount").toString()) > 0) {%>
            <a href="${pageContext.request.contextPath}/host/Host_getNoRelationDeviceBytype.do?type=hhtc">
                <span title="<%=hostNoRelationHhtcLists.get("itemsCount").toString()%>个大屏设备"
                      class="mm_head_option mm_head_record"><%=hostNoRelationHhtcLists.get("itemsCount").toString()%>个大屏设备</span>
            </a>
            <%}%>
            <%if (hostNoRelationHhrecLists != null && hostNoRelationHhrecLists.size() > 0 && Integer.parseInt(hostNoRelationHhrecLists.get("itemsCount").toString()) > 0) {%>
            <%--<a href="${pageContext.request.contextPath}/host/Host_getNoRelationDeviceBytype.do?type=hhrec">--%>
                <span title="<%=hostNoRelationHhrecLists.get("itemsCount").toString()%>个录播设备"
                      class="mm_head_option mm_head_user"><%=hostNoRelationHhrecLists.get("itemsCount").toString()%>个录播设备</span>
           <%-- </a>--%>
            <%}%>

            <%if (hostNoRelationHtprLists != null && hostNoRelationHtprLists.size() > 0 && Integer.parseInt(hostNoRelationHtprLists.get("itemsCount").toString()) > 0) {%>
            <a href="${pageContext.request.contextPath}/host/Host_getNoRelationDeviceBytype.do?type=htpr">
                <span title="<%=hostNoRelationHtprLists.get("itemsCount").toString()%>个投影机设备"
                      class="mm_head_option mm_head_htp"><%=hostNoRelationHtprLists.get("itemsCount").toString()%>个投影机设备</span>
            </a>
            <%}%>
            <%if (hostNoRelationHhtwbLists != null && hostNoRelationHhtwbLists.size() > 0 && Integer.parseInt(hostNoRelationHhtwbLists.get("itemsCount").toString()) > 0) {%>
            <a href="${pageContext.request.contextPath}/host/Host_getNoRelationDeviceBytype.do?type=hhtwb">
                <span title="<%=hostNoRelationHhtwbLists.get("itemsCount").toString()%>个白板一体机设备"
                      class="mm_head_option mm_head_hhtwb"><%=hostNoRelationHhtwbLists.get("itemsCount").toString()%>个白板一体机设备</span>
            </a>
            <%}%>

            <%
                if (hostNoRelationHhtcLists != null && hostNoRelationHhtcLists.size() > 0 && hostNoRelationHhrecLists != null && hostNoRelationHhrecLists.size() > 0) {
                    int hostNoRelationCount = Integer.parseInt(hostNoRelationLists.get("itemsCount").toString());
                    int hostNoRelationHhtcCount = Integer.parseInt(hostNoRelationHhtcLists.get("itemsCount").toString());
                    int hostNoRelationHhrecCount = Integer.parseInt(hostNoRelationHhrecLists.get("itemsCount").toString());
                    int hostNoRelationHtprCount = Integer.parseInt(hostNoRelationHtprLists.get("itemsCount").toString());
                    int hostNoRelationHhtwbCount = Integer.parseInt(hostNoRelationHhtwbLists.get("itemsCount").toString());
                    int hostNoRelationOtherCount = hostNoRelationCount - hostNoRelationHhrecCount - hostNoRelationHhtcCount - hostNoRelationHtprCount-hostNoRelationHhtwbCount;
                    if (hostNoRelationOtherCount > 0) {
            %>
            <a href="${pageContext.request.contextPath}/host/Host_getNoRelationDeviceBytype.do?type=other">
                            <span title="<%=hostNoRelationOtherCount%>个其它设备"
                                  class="mm_head_option mm_head_other"><%=hostNoRelationOtherCount%>个其它设备</span>
            </a>
            <%
                    }
                }%>
            ...
            <div class="scrollson">
                ...
                <%
                    for (Map<String, Object> obj : hostNoRelationList) {
                        ...
                        if (obj.get("host_username") != null && obj.get("host_username").equals("@error@")) {
                ...
                <div class="mm_listout" style="margin-top: 15px;">
                    ...
                    <div class="mm_list_option">
                        ...
                        <span hostId="<%=obj.get("id")%>" hostIpaddr="<%=obj.get("host_ip")%>"
                              class="mm_nogroup_list_machineset" style="background-position: -1px 0;"
                              title="编辑班级信息"></span>
                        <%
                            }
                        %>
                        <%
                            if (font.equals("在线") && hostDesc.equals("0")&&!hostDspecid.equals("11")) {
                        %>
                ...
                <%--<div class="mm_listout" style="margin-top: 15px;">--%>
                    ...
                    <%--<div class="mm_list_option">--%>
                        ...
                        <%--<a href="javascript:nvrView('<%=obj.get("host_ip").toString().trim()%>','<%=obj.get("host_username").toString()%>','<%=obj.get("host_password").toString()%>')"--%>
                           <%--style="cursor: default;">--%>
                            <%--&lt;%&ndash;<span class="mm_list_options mm_list_setnvr" style="float: right;"&ndash;%&gt;--%>
                            <%--&lt;%&ndash;title="查看NVR"></span>&ndash;%&gt;--%>
                        <%--</a>--%>
                        <%--<%}%>--%>
                    <%--</div>--%>
                <%--</div>--%>
...
<script>
    ...
    function device(hostId, hostIp, hostName) {
        ...
        location.href = "${pageContext.request.contextPath}/device/Device_deviceList.do?hostId=" + hostId + "&hostName=" + hostNameEncode + "&hostIp=" + hostIp+"&type=3";
    }
