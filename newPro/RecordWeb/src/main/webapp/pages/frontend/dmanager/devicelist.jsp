    ...
    <div class="allarea wid_50 floatleft">
        <div class="xk_video"  bingo="none" id="<%=host_id%>" ip="<%=hostip%>" >
            ...
            <div class="jkn_mc_hover">
                ...
                <!--<div class="jkn_mc_hover_name floatleft">磁盘容量：2g/4g</div>!--<div class="wid_47 floatleft">
                    <div class="jkn_mc_hover_title">教室：</div>
                    <div class="jkn_mc_hover_content">高二（2）班</div>
                    <div class="jkn_mc_hover_title">信号源：</div>
                    <div class="jkn_mc_hover_content">vga1</div>
                    <!--<div class="jkn_mc_hover_title">状态：</div>
                    <div class="jkn_mc_hover_content">开机</div>
                    <div class="jkn_mc_hover_title">连接状态：</div>
                    <div class="jkn_mc_hover_content">正常</div>
                    <div class="jkn_mc_hover_title">开机时长：</div>
                    <div class="jkn_mc_hover_content">10h</div>
                    <div class="jkn_mc_hover_title">内存：</div>
                    <div class="jkn_mc_hover_content">2g/4g</div>
                    <div class="jkn_mc_hover_title">cpu温度：</div>
                    <div class="jkn_mc_hover_content">50</div>-
                </div>
                <div class="wid_47 floatright">
                    <div class="jkn_mc_hover_title">磁盘容量：</div>
                    <div class="jkn_mc_hover_content">2g/4g</div>
                    <!--<div class="jkn_mc_hover_contentdetail"><div class="jkn_mc_hover_title">信息内容：</div>新年好新年好新年好新年好新年好新年好新年好新年好</div>
                </div>-->
            </div>
            <%}%>
        </div>
                    ...
                    $.post("${pageContext.request.contextPath}/dmanager/DManager_getImage.do",
                            ...
                            function(data){
                                for(var k=0;k<data.length;k++){
                                    ...
                                    if(typeof(imageUrl) != "undefined" && imageUrl != 0 && imageUrl != ""){
...
//                                    var currentCleanStatus = "";
//                                    var cleanstatus = $("#host_cmd_" + hostidstr).attr("clean_status");
//                                    var cleanstatus_cmd = $("#host_cmd_code_" + hostidstr).attr("clean_status_cmd");
//                                    if (cleanstatus != "null") {
//                                        var arr = cleanstatus.split(",");
//                                        var arr_cmd = cleanstatus_cmd.split(",");
//                                        for (var i = 0; i < arr.length; i++) {
//                                            if (arr_cmd[i] == oneKeyClean) {
//                                                currentCleanStatus = arr[i];
//                                            }
//                                        }
                                        //垃圾清理状态
...
//                                    }
    ...
    function screenhide(){
        $(".xk_video_selected").find(".jkn_mc_hover").hide();
        $(".xk_video").find(".jkn_mc_hover").hide();
    }
    /*if (self != top) {
...
//                    var list = $(".xk_video_selected");
//                    $.each(list,function(i,value){
//                        if(list.eq(i).attr("ip")==dapingip){
//                            list.eq(i).find(".jkn_mc_hover").show();
//                            setTimeout(screenhide,5000);
//                        }
//                    })
//                    var list1 = $(".xk_video");
//                    $.each(list1,function(i,value){
//                        if(list1.eq(i).attr("ip")==dapingip){
//                            list1.eq(i).find(".jkn_mc_hover").show();
//                            setTimeout(screenhide,5000);
//                        }
//                    })
                }
